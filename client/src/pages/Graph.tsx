...
import { ArrowRight, Crosshair, GitBranch, Move, Network, RotateCcw, ZoomIn, ZoomOut } from "lucide-react";
  ...
  return <div className="mx-auto max-w-[1620px]">
    ...
    <div className="mt-5 grid gap-5 xl:grid-cols-[minmax(0,1fr)_320px]">
      ...
      <aside className="rounded-3xl border border-white/8 bg-[#091423] p-5">
        {selectedNode && blast ? <BlastRadiusPanel node={selectedNode} blast={blast} onRoadmap={() => setLocation(`/roadmap${selectedFindingKey ? `?finding=${selectedFindingKey}` : ""}`)} /> : <GraphLegend />}
      </aside>
    </div>
  </div>;
}
